...
<table size="100%" id="property_table">
    ...
    <tr>
        <th>Name
            <br>
            <a href="other_owner_properties.php?sort=Name&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="other_owner_properties.php?sort=Name&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Address</th>
        <th>City</th>
        <th>Zip Code
            <br>
            <a href="other_owner_properties.php?sort=Zip&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="other_owner_properties.php?sort=Zip&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Size
            <br>
            <a href="other_owner_properties.php?sort=Size&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="other_owner_properties.php?sort=Size&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Type
            <br>
            <a href="other_owner_properties.php?sort=PropertyType&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="other_owner_properties.php?sort=PropertyType&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Public</th>
        <th>Commercial</th>
        <th>ID</th>
        <th>Visits
            <br>
            <a href="other_owner_properties.php?sort=Visits&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="other_owner_properties.php?sort=Visits&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Avg. Rating
            <br>
            <a href="other_owner_properties.php?sort=Rating&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="other_owner_properties.php?sort=Rating&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
    </tr>
    <?php
