...
$properties = $mysqli->query("SELECT * FROM (SELECT Property.Name, Property.Street, Property.City,
                ...
                WHERE ApprovedBy IS NOT NULL $searchquery $sorttype $sortdirection");
    ...
    <script>
        ...
        function onSearchPressed() {
            ...
            if (selectValue == "Size" || selectValue == "Rating" || selectValue == "Visits") {
                ...
                window.location.replace("confirmed_properties.php?searchtype="+selectValue+"&upper="+upBound+"&lower="+lowBound);
            } else {
                var searchText = document.getElementById("searchtext").value;
                window.location.replace("confirmed_properties.php?searchtype="+selectValue+"&searchtext="+searchText);
            }
        }
...
<table size="100%" id="property_table">
    ...
    <tr>
        <th>Name
        <br>
            <a href="confirmed_properties.php?sort=Name&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=Name&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Address</th>
        <th>City</th>
        <th>Zip Code
            <br>
            <a href="confirmed_properties.php?sort=Zip&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=Zip&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Size
            <br>
            <a href="confirmed_properties.php?sort=Size&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=Size&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Type
            <br>
            <a href="confirmed_properties.php?sort=PropertyType&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=PropertyType&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Public</th>
        <th>Commercial</th>
        <th>ID</th>
        <th>Approved Username
            <br>
            <a href="confirmed_properties.php?sort=ApprovedBy&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=ApprovedBy&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Visits
            <br>
            <a href="confirmed_properties.php?sort=Visits&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=Visits&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
        <th>Avg. Rating
            <br>
            <a href="confirmed_properties.php?sort=Rating&sort_direction=ASC<?php echo $searchurl; ?>">ASC</a>
            <a href="confirmed_properties.php?sort=Rating&sort_direction=DESC<?php echo $searchurl; ?>">DESC</a>
        </th>
    </tr>
