    ...
    <script>
        ...
        function onSearchPressed() {
            ...
            if (selectValue == "Size" || selectValue == "Rating" || selectValue == "Visits") {
                ...
                window.location.replace("unconfirmed_properties.php?searchtype="+selectValue+"&upper="+upBound+"&lower="+lowBound);
            } else {
                var searchText = document.getElementById("searchtext").value;
                window.location.replace("unconfirmed_properties.php?searchtype="+selectValue+"&searchtext="+searchText);
            }
        }
